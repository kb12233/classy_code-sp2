...
import { TransformWrapper, TransformComponent } from "react-zoom-pan-pinch"; // Import the necessary components
        ...
        {(image || selectedHistory) && (
          ...
          >
            <TransformWrapper
              ...
              pinch={{ step: 0.2 }}
              doubleClick={{ step: 1 }}
              onWheel={handleZoom} // Keep this to prevent default scrolling
            >
