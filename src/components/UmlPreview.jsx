...
const UMLPreviewDisplay = ({ isCodeGeneratedVisible }) => {
    ...
    const theme = useTheme(); // Use useTheme from Material UI
    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    height: '65vh',
                    flexWrap: isSmallScreen ? 'wrap' : 'nowrap', // Wrap on small screens
                }}
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        flex: 1,
                        maxHeight: isSmallScreen ? 'none' : '70vh', // Allow full height on small screens
                        width: isSmallScreen ? '100%' : '50%', // Take full width on small screens
                    }}
                >
                ...
                <div
                    ...
                    style={{
                        backgroundColor: grayish,
                        flex: 1,
                        maxHeight: isSmallScreen ? 'none' : '70vh',
                ...
                >
                    {loading && !isEditing ? (
                        <Box
                            className="flex flex-col space-y-3 flex-grow flex items-center justify-center"
                            sx={{ marginTop: '3%' }}
                        >
